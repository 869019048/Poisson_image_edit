...
for src_st_x = 165 :260
    ...
    %if src_st_x == 165 || src_st_x == 190 ||src_st_x == 210|| src_st_x == 240 || src_st_x == 260
    imwrite(uint8(padded_src_img),strcat('.\result4\',num2str(src_st_x),'.bmp'));
    %end
    ...
    %if src_st_x == 165 || src_st_x == 190 ||src_st_x == 210|| src_st_x == 240 || src_st_x == 260
    imwrite(uint8(temp_result),strcat('.\result4\',num2str(src_st_x),'.bmp'));
    %end
    ...
    %imwrite(uint8(dst_img),strcat('.\result2\',num2str(src_st_x),'.bmp'));
end